...
const navItems = [
  ...
  { href: "#progress", label: "Tiến độ", icon: CheckCircle2 },
  { href: "#scoring", label: "Chấm điểm", icon: Smartphone },
  { href: "#sessions", label: "Lịch kiểm tra", icon: CalendarDays },
  { href: "#reports", label: "Báo cáo Excel", icon: FileSpreadsheet },
  { href: "#capa", label: "CAPA", icon: Wrench },
  { href: "#guide", label: "Hướng dẫn", icon: FileText },
  { href: "#admin", label: "Quản trị", icon: Database }
];
  ...
  return (
    <main className="app-shell min-h-screen">
      <header className="sticky top-0 z-50 border-b border-hospital-100 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3">
          ...
          {currentUser ? (
            ...
            <a href="#login" className="hidden min-h-10 items-center gap-2 rounded-md bg-hospital-800 px-3 text-sm font-semibold text-white md:inline-flex">
        ...
        <nav className="mx-auto flex max-w-7xl gap-2 overflow-x-auto px-4 pb-3">
          {navItems.map((item) => (
            <a key={item.href} href={item.href} className="inline-flex min-h-9 shrink-0 items-center gap-2 rounded-md border border-slate-200 bg-white px-3 text-sm font-semibold text-slate-700">
              <item.icon className="h-4 w-4 text-hospital-700" />
              {item.label}
            </a>
          ))}
        </nav>
        ...
        <div className="mx-auto grid max-w-7xl gap-5 px-4 py-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
          <div>
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              <a href="#dashboard" className="inline-flex min-h-11 items-center gap-2 rounded-md bg-hospital-800 px-4 py-2 font-semibold text-white">
                <BarChart3 className="h-4 w-4" />
                Xem dashboard
              </a>
              <a href="#scoring" className="inline-flex min-h-11 items-center gap-2 rounded-md border border-hospital-200 bg-white px-4 py-2 font-semibold text-hospital-800">
            ...
            <div className="mx-auto w-full max-w-[430px] rounded-[24px] border border-slate-200 bg-slate-950 p-2 shadow-lg lg:max-w-none lg:rounded-md lg:bg-transparent lg:p-0 lg:shadow-none">
              <div className="max-h-[780px] overflow-y-auto rounded-[20px] bg-slate-50 p-3 lg:rounded-md">
                ...
                <div className="sticky bottom-0 mt-3 grid grid-cols-2 gap-2 border-t border-slate-200 bg-slate-50 pt-3">
                  ...
                  {!writable ? (
                    <a href="#login" className="col-span-2 inline-flex min-h-11 items-center justify-center gap-2 rounded-md bg-hospital-800 px-4 text-sm font-semibold text-white">
                      <LogIn className="h-4 w-4" />
      ...
      <footer className="mt-6 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-4 text-sm font-semibold text-hospital-900">
